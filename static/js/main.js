...
changeTheme(localStorage.getItem('tema_dms_portifolio'))
function CapTheme() {
    const valor = localStorage.getItem('tema_dms_portifolio')
    const texto_tema = document.getElementById('current-theme');
    if (valor == 'dark') {
        changeTheme('light')
    } else {
        changeTheme('dark')
